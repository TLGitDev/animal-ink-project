...
export const Button = ({ variant = 'primary', size = 'md', loading = false, icon, className = '', disabled, children, ...props }) => {
    ...
    return (_jsxs("button", { className: buttonClasses, disabled: loading || disabled, ...props, children: [icon, children] }));
};
